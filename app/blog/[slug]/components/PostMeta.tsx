...
export default function PostMeta({ post, author, category }: PostMetaProps) {
  ...
  const shareOnTwitter = () => {
    ...
    const url = `https://twitter.com/intent/tweet?text=${encodeURIComponent(text)}&url=${encodeURIComponent(currentUrl)}&via=ALTUMLegal`;
      ...
      <div className="border-b border-gray-100 pb-6">
        ...
        <div className="flex space-x-3">
          ...
          <button 
            ...
            className="flex items-center justify-center w-8 h-8 bg-gray-100 hover:bg-blue-100 rounded transition-colors duration-200 group"
            title="Compartir en Twitter"
          >
            <svg className="w-4 h-4 text-gray-600 group-hover:text-blue-500" fill="currentColor" viewBox="0 0 24 24">
          ...
          <button 
            ...
            className="flex items-center justify-center w-8 h-8 bg-gray-100 hover:bg-green-100 rounded transition-colors duration-200 group"
            title="Copiar enlace"
          >
