...
export const AttorneyHorizontalCarousel: React.FC = () => {
  ...
  const [sliderState, setSliderState] = useState<SliderState>({
    currentIndex: 0,
    visibleCardsCount: 4, // Inicializar con 4 tarjetas GRANDES
      ...
      <section className="py-16 bg-neutral-50">
        <div className="w-full">
          ...
          <div className="relative">
            ...
            >
              <div className="flex h-full transition-transform duration-1500 ease-in-out" style={{ gap: 0, margin: 0, padding: 0 }}>
