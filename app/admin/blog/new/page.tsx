...
export default function NewBlogPost() {
  ...
  const handleSubmit = async (status: PostStatus) => {
    ...
    try {
      ...
      alert(`Post ${status === PostStatus.PUBLISHED ? 'publicado' : 'guardado como borrador'} exitosamente!`);
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 border border-stone-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 text-slate-900"
                    >
